...
const NavBar = ({ setFilterType, setSortType, filterType, sortType}) => {
  ...
  return (
    <header>
      ...
      <img src={`${process.env.PUBLIC_URL}/assets/Display.svg`} alt="Display Icon" className="filter-icon" />
  Display
  <span className="arrow-down">&#9662;</span>
        ...
        {dropdownOpen && (
          <div className="dropdown" ref={dropdownRef} style={{ position: 'absolute', left:'20px',top:"80px"}}> {/* Right align */}
